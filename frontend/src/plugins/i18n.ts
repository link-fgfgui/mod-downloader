  ...
  zh: {
    ...
    manage: {
      ...
      crossVersionCopy: {
        matched: "{n} 个可复制",
        conflicts: "{n} 个冲突",
        target: "将自动创建收藏夹「{name}」，作用域为 Minecraft {minecraftVersion} / {modLoader}",
        nameConflict: "目标作用域已存在同名收藏夹，无法执行跨版本复制。",
        success: "已复制到「{name}」：新增 {added}，跳过 {skipped}",
        notApplied: "跨版本复制未执行：{reason}",
        unknownError: "未知错误",
      },
      empty: {
        noLists: "还没有收藏夹。",
  ...
  en: {
    ...
    favorites: {
      ...
      crossVersionCopy: {
        ...
        target: "A list named \"{name}\" will be created for Minecraft {minecraftVersion} / {modLoader}",
        nameConflict: "A list with the same name already exists in the target scope. Copy Across Versions cannot continue.",
        success: "Copied to \"{name}\": {added} added, {skipped} skipped",
        notApplied: "Copy Across Versions was not applied: {reason}",
      ...
      actions: {
        ...
        create: "Create",
         ...
         copyAcrossVersions: "Copy Across Versions",
         pin: "Pin",
         preview: "Preview",
      ...
      dialog: {
        ...
        crossVersionCopyTitle: "Copy Across Versions",
